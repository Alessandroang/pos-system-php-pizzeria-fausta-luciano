            ...
            <div class="nav">
                ...
                <div class="collapse
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link <?= $page == 'categories.php' ? 'active' : '' ?>" href="categories.php">Views
                            Categories</a>
                    </nav>
                </div>


                <a class="nav-link <?= $page == 'products-create.php' || $page == 'products.php' ? 'show' : '' ?>"
                ...
                <div class="collapse <?= $page == 'products-create.php' || $page == 'products.php' ? 'show' : '' ?>"
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?= $page == 'products-create.php' ? 'active' : '' ?>"
                            href="products-create.php">Create Product</a>
                        <a class="nav-link <?= $page == 'products.php' ? 'active' : '' ?>" href="products.php">Views
                            Products</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseCustomer" aria-labelledby="headingOne"
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?= $page == 'customers-create.php' ? 'active' : '' ?>"
                            href="customers-create.php">Add Customer</a>
                        <a class="nav-link <?= $page == 'customers.php' ? 'active' : '' ?>" href="customers.php">Views
                            Customers</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseAdmins" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?= $page == 'admins-create.php' ? 'active' : '' ?>"
                            href="admins-create.php">Add Admin</a>
                        <a class="nav-link <?= $page == 'admins.php' ? 'active' : '' ?>" href="admins.php">Views
                            Admins</a>
                    </nav>
                </div>
            </div>
