                ...
                <form action="code.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="name" required value="<?= $customer['data']['name'] ?>"
                                class="form-control">
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="">Email Id</label>
                            <input type="email" name="email" value="<?= $customer['data']['email'] ?>"
                                class="form-control">
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="">Phone</label>
                            <input type="number" name="phone" value="<?= $customer['data']['phone'] ?>"
                                class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="checkbox" name="status"
                                <?= $customer['data']['status'] == true ? 'checked' : '' ?>
