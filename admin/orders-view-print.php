                        ...
                        <tr>
                            ...
                            <td align="end">
                                ...
                                <p style="font-size: 14px; line-height: 2opx; margin: 2px; padding: 0;">Invoice
                                    Number: <?= $orderDataRow['invoice_no'] ?></p>
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="border-bottom: 1px solid #ccc;" class="fw-bold">
                                    <?= number_format($row['orderItemPrice'] * $row['orderItemQuantity'], 0) ?></td>
                            </tr>
                            <?php endforeach; ?>
                            <tr>
...
?>
            ...
            <div class="mt-4 text-end">
                ...
                <button class="btn btn-primary px-4 mx-1"
                    onclick="downloadPDF('<?= $orderDataRow['invoice_no'] ?>')">Download PDF
                </button>
            </div>
