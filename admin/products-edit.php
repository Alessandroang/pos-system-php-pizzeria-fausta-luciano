                ...
                <form action="code.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="price" required value="<?= $product['data']['price'] ?>"
                                class="form-control">
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="">Quantity *</label>
                            <input type="text" name="quantity" required value="<?= $product['data']['quantity'] ?>"
                                class="form-control">
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <img src="../<?= $product['data']['image'] ?>" style="width:50px;height:50px;"
                                alt="Img">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="checkbox" name="status"
                                <?= $product['data']['status'] == true ? 'checked' : '' ?>
